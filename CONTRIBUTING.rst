...
Code Contributions
------------------
bootstrap is primarily written in Python3.  Code should be formatted according
to PEP8_, preferably with an automatic tool like autopep8_; when in conflict,
...
those contributing to and using bootstrap) have to deal with the raw text.
...
.. _Github: https://github.com/crazyorc/bootstrap
